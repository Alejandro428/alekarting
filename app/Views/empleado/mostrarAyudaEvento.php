    ...
    <div class="modal-content overflow-hidden" style="border: none; border-radius: 15px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.2);">
      ...
      <div class="modal-header border-0 text-white" style="background: linear-gradient(135deg, #17a2b8 0%, #2c3e50 100%);">
        <div class="d-flex align-items-center w-100">
          ...
          <h5 class="modal-title mb-0" id="modalAyudaGestionEventosLabel" style="font-weight: 700; letter-spacing: 0.5px;">AYUDA - GESTIÓN DE EVENTOS EMPLEADO</h5>
      ...
      <div class="modal-body p-4" style="background-color: #f8fafc;">
        ...
        <section class="mb-4">
          ...
          <ul style="color: #444; font-size: 1rem; line-height: 1.5;">
            <li><strong>Crear eventos:</strong> Crear un evento con sus detalles necesarios (Título, imagen, etc). El evento queda disponible inmediatamente para recibir reservas.</li>
            <li><strong>Crear reservas:</strong> El empleado puede realizar reservas a usuarios. Se especifica el evento, el usuario, número de personas, etc. Se envía un correo con los detalles. La reserva queda como no pagada inicialmente.</li>
            <li><strong>Gestión de pagos:</strong> El empleado puede marcar reservas como pagadas posteriormente. Esto notifica al usuario por correo.</li>
          </ul>
        </section>

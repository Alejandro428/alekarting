<div class="modal fade" id="modalEmpleado" tabindex="-1" aria-labelledby="modalMostrarCarreraLabel" aria-hidden="true">
        ...
        <form id="formCarrera">
          ...
          <div class="form-container" style="margin-left: 15px; margin-right: 15px;">
              ...
              <div class="card-body">
                ...
                <div class="form-group row mb-3">
                  ...
                  <div class="col-12 col-lg-9">
                    <select id="id_usuario" name="id_usuario" class="form-control w-100" required>
                ...
                <div class="form-group row mb-3">
                  <div class="col-12 col-lg-3">
                    <label for="pista" class="form-label">Pista:<span class="tx-danger">*</span></label>
                  </div>
                  <div class="col-12 col-lg-9">
                    <select id="id_pista" name="id_pista" class="form-control w-100" required>
                      <!-- Vacío, se llenará vía AJAX -->
                    </select>
                    <div class="invalid-feedback small-invalid-feedback">
                ...
                <div class="form-group row mb-3">
                  <div class="col-12 col-lg-3">
                    <label for="num_participantes" class="form-label">Participantes:<span class="tx-danger">*</span></label>
                  </div>
                  <div class="col-12 col-lg-9">
                    <input type="number" id="num_participantes" name="num_participantes" class="form-control w-100" placeholder="Número de participantes" min="1" required>
                    <div class="invalid-feedback small-invalid-feedback">
                      El número de participantes es requerido (máx. 20).
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="card mb-4 border-info">
              ...
              <div class="card-body">
                <!-- FECHA CARRERA - MODIFICADO -->
                <div class="form-group row mb-3">
                  <div class="col-12 col-lg-3">
                    <label for="fecha_carrera" class="form-label">Fecha carrera:<span class="tx-danger">*</span></label>
                  </div>
                  <div class="col-12 col-lg-9">
                    <div class="d-flex align-items-center">
                      <div class="input-group flex-nowrap w-100">
                        ...
                        <input id="fecha_carrera" name="fecha_carrera" type="text" class="form-control fc-datepicker" placeholder="dd-mm-aaaa" readonly required>
                      </div>
                    </div>
                ...
                <div class="form-group row mb-3">
                  ...
                  <div class="col-12 col-lg-9">
                    <select id="id_horario" name="id_horario" class="form-control w-100" required>
                      <!-- Vacío, se llenará vía AJAX -->
                    </select>
                    <div class="invalid-feedback small-invalid-feedback">
            ...
            <div class="card mb-4 border-success">
              ...
              <div class="card-body">
                ...
                <div class="form-group row mb-3">
                  <div class="col-12 col-lg-3">
                    <label for="metodo_pago" class="form-label">Método:<span class="tx-danger">*</span></label>
                  </div>
                  <div class="col-12 col-lg-9">
                    <select id="metodo_pago" name="metodo_pago" class="form-control w-100" required>
                      <option value="card">Tarjeta</option>  
                      <option value="paypal">Paypal</option>
                      <option value="presencial">Pago presencial</option>
                    </select>
                    <div class="invalid-feedback small-invalid-feedback">
                      Por favor selecciona un método.
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group row mb-3">
                  ...
                  <div class="col-12 col-lg-9">
                    <input type="number" id="precio" name="precio" class="form-control w-100" placeholder="Precio" readonly required>
                    <div class="invalid-feedback small-invalid-feedback">
                ...
                <!-- FECHA DE PAGO - MODIFICADO -->
                <div class="form-group row mb-0">
                  <div class="col-12 col-lg-3">
                    <label for="fecha_pago" class="form-label">Fecha Pago:<span class="tx-danger">*</span></label>
                  </div>
                  <div class="col-12 col-lg-9">
                    <div class="d-flex align-items-center">
                      <div class="input-group flex-nowrap w-100">

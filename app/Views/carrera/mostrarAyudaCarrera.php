<!-- MODAL AYUDA CALENDARIO DE CARRERAS - VERSIÓN COMPLETA CON GUÍA DE RESERVA -->
      ...
      <div class="modal-body p-4" style="background-color: #f8fafc;">
        ...
        <section class="mb-4">
          ...
          <ul style="color: #444; font-size: 1rem; line-height: 1.5;">
            ...
            <li>Si al intentar hacer la reserva no hay empleados de carreras operativos en ese momento, la reserva no podrá completarse.</li>
            <li>Se puede seleccionar cualquier fecha válida, pero al confirmar se validará que cumpla con todas las reglas.</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul style="color: #444; font-size: 1rem; line-height: 1.5;">
            ...
            <li><span class="color-dia gris"></span> El día tiene algunas reservas.</li>
            <li><span class="color-dia azul"></span> El día tiene una reserva hecha por ti.</li>
        ...
        <section class="mt-3">
          ...
          <ul style="color: #444; font-size: 1rem; line-height: 1.5;">
            ...
            <li><span class="color-horario gris"></span> Horario del día actual que ya ha pasado.</li>
            <li><span class="color-horario rojo-oscuro"></span> Horario reservado y finalizado.</li>
            <li><span class="color-horario azul"></span> Horario reservado por ti (haz clic para ver el resumen).</li>
            <li><span class="color-horario rojo"></span> Horario reservado por otro usuario.</li>
          </ul>
        </section>

        <section class="mt-4">
          <h5 style="color: #17a2b8; font-weight: 600;">¿Cómo hacer una reserva de carrera?</h5>
          <ul style="color: #444; font-size: 1rem; line-height: 1.5;">
            <li>Puedes seleccionar una fecha y horario disponibles desde el calendario.</li>
            <li>Si accedes desde una fecha y hora escogidos (desde el apartado de calendario de carreras), ese día y hora aparecerán preseleccionados.</li>
            <li>Los días totalmente reservados y días pasados no estarán disponibles.</li>
            <li>Para completar tu reserva necesitas seleccionar:
              <ul>
                <li>El <strong>día</strong> de la carrera.</li>
                <li>El <strong>horario</strong> disponible.</li>
                <li>El <strong>tipo de pista</strong> (infantil, adolescente o adulto; se podrán añadir más en el futuro).</li>
                <li>La <strong>cantidad de entradas</strong> que deseas (máximo 20 por reserva).</li>
              </ul>
            </li>
            <li>Si tienes la sesión iniciada, todos los campos están completos <strong>y aceptas los términos y condiciones</strong>, se te redirigirá automáticamente a la pasarela de pago.</li>
          </ul>
        </section>

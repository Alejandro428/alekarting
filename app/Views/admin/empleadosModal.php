<div class="modal fade" id="modalEmpleado" tabindex="-1" aria-labelledby="modalMostrarEmpleadoLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header pd-y-20 pd-x-25">
        <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Empleados</h6>
      ...
      <div class="modal-body pd-25">
        <h4 class="lh-3 mg-b-20" id="mdltitulo">
          <a href="" class="tx-inverse hover-primary">Modal de empleados</a>
        </h4>
        <form id="formEmpleado">
          ...
          <div class="form-container" style="margin-left: 15px; margin-right: 15px;">
            ...
            <!-- BLOQUE 4: Roles -->
            <div class="card mb-4 border-warning campos-roles">
              <div class="card-header bg-warning text-white">
                <h5 class="mb-0 tx-bold">Roles y Permisos</h5>
              </div>
              <div class="card-body">
                <div class="form-group row mb-0">
                  <div class="col-12 col-lg-3">
                    <label class="form-label">Roles: <span class="tx-danger">*</span></label>
                  </div>
                  <div class="col-12 col-lg-9">
                    <div class="form-check mb-2">
                      <input class="form-check-input" type="checkbox" name="roles[]" id="emp_noticia" value="emp_noticia">
                      <label class="form-check-label" for="emp_noticia">Noticia</label>
                    </div>
                    <div class="form-check mb-2">
                      <input class="form-check-input" type="checkbox" name="roles[]" id="emp_evento" value="emp_evento">
                      <label class="form-check-label" for="emp_evento">Evento</label>
                    </div>
                    <div class="form-check mb-2">
                      <input class="form-check-input" type="checkbox" name="roles[]" id="emp_carreras" value="emp_carreras">
                      <label class="form-check-label" for="emp_carreras">Carrera</label>
                    </div>
                    <div id="error-roles" class="invalid-feedback">Debe seleccionar al menos un rol</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="modal-footer">
        <!-- Botón para guardar como admin -->
        <button type="button" id="btnsalvarAdmin" class="btn btn-success tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium" style="display:none;">
          <i class="bi bi-shield-lock me-2"></i>Guardar Admin
        </button>

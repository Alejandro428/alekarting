    ...
    <div class="modal-content overflow-hidden" style="border: none; border-radius: 15px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.2);">
      ...
      <div class="modal-header border-0 text-white" style="background: linear-gradient(135deg, #17a2b8 0%, #2c3e50 100%);">
        <div class="d-flex align-items-center w-100">
          ...
          <h5 class="modal-title mb-0" id="modalAyudaGestionCarrerasLabel" style="font-weight: 700; letter-spacing: 0.5px;">AYUDA - GESTIÓN DE CARRERAS ADMINISTRADOR</h5>
      ...
      <div class="modal-body p-4" style="background-color: #f8fafc;">
        ...
        <section class="mb-4">
          <h5 style="color: #17a2b8; font-weight: 600;">Gestión de pistas</h5>
          <ul style="color: #444; font-size: 1rem; line-height: 1.5;">
            <li>El administrador puede <strong>crear, editar o eliminar pistas</strong>.</li>
            <li>No se permite eliminar pistas que ya tienen carreras asociadas ni duplicar nombres.</li>
          </ul>
        </section>
        ...
        <section class="mb-4">
          ...
          <ul style="color: #444; font-size: 1rem; line-height: 1.5;">
            <li>El administrador define la reserva de la carrera, el empleado responsable y todos los detalles que son necesarios.</li>
        ...
        <section class="mb-4">
          ...
          <ul style="color: #444; font-size: 1rem; line-height: 1.5;">
            ...
            <li>Editar una reserva está permitido si la carrera no ha pasado. Solo se puede cambiar el empleado, la fecha u horario.</li>
        ...
        <section class="mb-4">
          ...
          <ul style="color: #444; font-size: 1rem; line-height: 1.5;">
            ...
            <li><strong>Editar:</strong> Disponible solo si la carrera no ha pasado. Solo se puede modificar el empleado asignado, la fecha y el horario.</li>
